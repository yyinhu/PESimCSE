        ...
        if model_args.dup_type == "word":
            ...
            for sent in examples[sent1_cname]:
                ...
                for i1, x1 in enumerate(phrase_list):
                    is_in = False
                    for i2, x2 in enumerate(phrase_list):
                        if i1 == i2:
                            continue
                        if x1 in x2:
                            is_in = True
                ...
                if sent_len > 0:
                    ...
                    if replace_len > 0:
                        for i, phrase in enumerate(phrase_list):
                            phrase_len_list = phrase.split(' ')
                            replace_list.append(phrase)
                            number = number + len(phrase_len_list)
                            if number == replace_len or i == len(phrase_list) - 1:
                                break
